        ...
        <div className="h-[220px]">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={trafficData}>
              ...
              <Area type="monotone" dataKey="visitors" stroke="hsl(240,60%,65%)" strokeWidth={2} fill="url(#aGrad)" />
              <Area type="monotone" dataKey="pageViews" stroke="hsl(152,60%,52%)" strokeWidth={2} fill="transparent" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </AnimatedCard>
        ...
        <div className="h-[220px]">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={conversionData}>
              ...
              <YAxis hide />
              <Bar dataKey="rate" radius={[6, 6, 0, 0]} fill="hsl(240,60%,65%)" />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </AnimatedCard>
